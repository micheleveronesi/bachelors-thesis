...
\input{capitoli/capitolo-2}             % analisi problema
\input{capitoli/capitolo-3}             % tecnologie
\input{capitoli/capitolo-4}             % business logic (sviluppo, testing, ...)
\input{capitoli/capitolo-5}             % modello machine learning, creazione dataset, analisi prestazioni
\input{capitoli/capitolo-6}             % Conclusioni, valutazione retrospettiva
\appendix                               
