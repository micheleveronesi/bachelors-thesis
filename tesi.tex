...
\begin{filecontents*}{\jobname.xmpdata}
  \Title{Sistema di navigazione per droni ricognitivi basato su apprendimento automatico}
  \Author{Michele Veronesi}
  \Language{it-IT}
  \Subject{Studio di fattibilità per un sistema di navigazione per droni basato sul rilevamento delle firme spettrali di oggetti sorvolati.}
  \Keywords{apprendimento-automatico\sep firme-spettrali\sep drone}
\end{filecontents*}
...
\input{capitoli/capitolo-2}             % dataset e ML
\input{capitoli/capitolo-3}             % business logic
\input{capitoli/capitolo-4}             % conclusioni
\appendix                               
